    ...
    <div class="container-fluid">
      <div class="container">
        <div class="row">
            <div class="col-sm-8">
              <ul class="list-inline footer-list">
                ...
                <li><a href="">About Danasiswa</a></li>
                <li><a href="" target="_blank"><?= $this->text('footer-resources-stats') ?></a></li>
                <li><a href=""><?= $this->text('regular-footer-terms')?></a></li>
                <li><a href=""><?= $this->text('regular-footer-privacy')?></a></li>
                <li><a data-jslicense="1" href="">Licenses</a></li>
                <li><a href=""><?= $this->text('regular-header-faq')?></a></li>
                <li><a href=""><?= $this->text('regular-footer-contact')?></a></li>
            ...
            <div class="col-sm-4 hidden-xs">
              <ul class="list-inline text-right">
                ...
                <li>
                    <!--
                    <a href="<?= $this->lang_host() ?>blog"><img src="/view/css/logoFG.png" class="img-responsive logo" alt="Fundación Goteo"></a>
                    -->
                    Danasiswa Foundation
                </li>
              </ul>
            </div>
        </div>
        <div class="social text-center">
          ...
          <a class="fa fa-telegram" target="_blank" href=""></a>
          <a class="fa fa-github" target="_blank" href=""></a>
          <a class="fa fa-newspaper-o" target="_blank" href=""></a>
        </div>
      </div>
    </div>
</footer>
